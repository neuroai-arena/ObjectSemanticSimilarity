...
from typing import Dict, Iterable, Optional, Callable, Tuple, Any
from torch import nn

"""
    Copied from https://github.com/NUS-HPC-AI-Lab/LARS-ImageNet-PyTorch/blob/main/lars.py
...
class LARS2(Optimizer):
    ...
    def __init__(self, optimizer, params, defaults, trust_coefficient=0.001):
