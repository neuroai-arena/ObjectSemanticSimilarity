...
def resnet18_cifar(*args,**kwargs):
    resnet = _resnet(BasicBlock, [2, 2, 2, 2], **kwargs)
    resnet.conv1 = nn.Conv2d(3, 64, 3, 1, 1, bias=False)
    resnet.maxpool = nn.Identity()
    return resnet

def resnet50_cifar(*args,**kwargs):
    resnet = _resnet(Bottleneck, [3, 4, 6, 3], **kwargs)
    resnet.conv1 = nn.Conv2d(3, 64, 3, 1, 1, bias=False)
    resnet.maxpool = nn.Identity()
    return resnet
#
...
#         setattr(self.encoder, 'fc', nn.Identity())
#         self.num_output = 512
#
#
#
